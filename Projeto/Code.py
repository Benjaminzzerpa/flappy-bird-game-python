...
class Passaro:
    ...
    def desenhar(self, tela):
        ...
        pos_centro_imagen = self.imagen.get_rect(topleft=(self.x, self.y)).center
        retangulo = imagen_rotacionada.get_rect(center=pos_centro_imagen)
...
class Chao:
    ...
    def desenhar(self, tela):
        ...
        tela.blit(self.IMAGEN, (self.x2, self.y))
...
def main(): 
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            if (passaro.y + passaro.imagen.get_height()) > chao.y or passaro.y < 0:
                passaros.pop(i)
